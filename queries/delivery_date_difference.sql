...
SELECT oc.customer_state as State, CAST(AVG(JULIANDAY(order_estimated_delivery_date) - JULIANDAY(order_delivered_customer_date)) AS int) as Delivery_Difference
